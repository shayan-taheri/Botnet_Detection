...
for i in range(len(X_test)):
  ...
  #  xadvs = [xorg] + xadvs
    ...
    fig = plt.figure()
    plt.imshow(xorg)
    plt.savefig('/home/shayan/PycharmProjects/attack_compact/mnist/original_mnist_' + str(i) + '.png')
    plt.close(fig)

    fig = plt.figure()
    plt.imshow(xadvs[0])
    plt.savefig('/home/shayan/PycharmProjects/attack_compact/mnist/xadvs_fgsm_mnist_' + str(i) + '.png')
    plt.close(fig)

    fig = plt.figure()
    plt.imshow(xadvs[1])
    plt.savefig('/home/shayan/PycharmProjects/attack_compact/mnist/xadvs_jsma_mnist_' + str(i) + '.png')
    plt.close(fig)

    fig = plt.figure()
    plt.imshow(xadvs[2])
    plt.savefig('/home/shayan/PycharmProjects/attack_compact/mnist/xadvs_deepfool_mnist_' + str(i) + '.png')
    plt.close(fig)
