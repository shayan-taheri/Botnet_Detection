...
for i3 in range(0, 23):
    for filename in glob.glob('/home/shayan/PycharmProjects/Dataset/New_Norm/' + str(i3) + '/*.png'):
...
'''
for i4 in range(0, 4):
    for filename in glob.glob('/home/shayan/PycharmProjects/Dataset/New_Bot/' + str(i4) + '/*.png'):
        im = cv2.imread(filename)
        im = cv2.resize(im, (224, 224)).astype(np.float32)
        # Subtract mean pixel and multiple by scaling constant
        # Reference: https://github.com/shicai/DenseNet-Caffe
